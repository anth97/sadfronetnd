...
export class HeaderComponent implements OnInit, AfterViewInit {
  ...
  mobileMenuSidebarOpen(event: any, className: string) {
    if (window.innerWidth < 1025) {
      ...
      if (hasClass) {
        this.renderer.removeClass(this.document.body, 'side-closed');
        this.renderer.setAttribute(this.document.getElementById("imagenlogotiposat"), 'src', 'assets/images/logotipo.png')
        this.renderer.removeClass(this.document.body, 'submenu-closed');
      } else {
        this.renderer.addClass(this.document.body, 'side-closed');
        this.renderer.setAttribute(this.document.getElementById("imagenlogotiposat"), 'src', 'assets/images/isotipo.png')
        this.renderer.addClass(this.document.body, 'submenu-closed');
      }
    }
  }
